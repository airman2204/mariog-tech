...
export const translations = {
  es: {
    ...
    copilot: {
      tag: 'Asistente Felina',
      title: 'Conversa con',
      titleHighlight: 'Lua 🐾',
      subtitle: 'La compañera de trabajo más leal de Mario. Conoce sus secretos, proyectos en Scrum, automatizaciones con Python y cómo lidera squads de software.',
      botStatus: 'RONRONEANDO • EN VIVO',
      botTitle: 'Lua 🐾 (La gata de Mario)',
      quickQuestionsTitle: 'Preguntas Rápidas para Lua',
      greeting: '¡Hola! 🐾 Soy Lua, la gata de Mario. Siempre estoy con él en cada sprint y conozco todos sus secretos de trabajo. Dime, ¿qué quieres saber de él?',
      inputPlaceholder: 'Pregúntale a Lua sobre Mario...',
      send: 'Enviar',
  ...
  en: {
    ...
    copilot: {
      tag: 'Feline Assistant',
      title: 'Chat with',
      titleHighlight: 'Lua 🐾',
      subtitle: 'Mario\'s most loyal desk companion. Discover his work habits, Scrum projects, Python automations, and how he leads engineering squads.',
      botStatus: 'PURRING • ONLINE',
      botTitle: 'Lua 🐾 (Mario\'s Cat)',
      quickQuestionsTitle: 'Quick Questions for Lua',
      greeting: 'Hi! 🐾 I am Lua, Mario\'s cat. I sit beside him during every sprint and know all his work secrets. Tell me, what would you like to know about him?',
      inputPlaceholder: 'Ask Lua about Mario...',
      send: 'Send',
