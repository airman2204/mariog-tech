...
export const translations = {
  es: {
    ...
    copilot: {
      tag: 'Asistente Interactivo',
      title: 'Conoce Más con mi',
      titleHighlight: 'Agente de IA',
      subtitle: 'Conversa con mi asistente virtual para conocer a detalle mi forma de trabajo en Scrum, automatizaciones con Python/Apps Script y casos de éxito.',
      botStatus: 'ONLINE',
      botTitle: 'Mario González AI',
      quickQuestionsTitle: 'Preguntas Rápidas',
      greeting: '¡Hola! Soy el Agente de IA de Mario. Pregúntame todo lo que quieras saber sobre mí y mi experiencia laboral.',
      inputPlaceholder: 'Escribe una pregunta sobre Mario...',
      send: 'Enviar',
  ...
  en: {
    ...
    copilot: {
      tag: 'Interactive Assistant',
      title: 'Learn More with my',
      titleHighlight: 'AI Agent',
      subtitle: 'Chat with Mario\'s AI assistant to explore his Scrum approach, Python / Apps Script automations, and project case studies.',
      botStatus: 'ONLINE',
      botTitle: 'Mario González AI',
      quickQuestionsTitle: 'Quick Questions',
      greeting: 'Hi! I am Mario\'s AI Agent. Ask me anything you want to know about me and my work experience.',
      inputPlaceholder: 'Type a question about Mario...',
      send: 'Send',
