...
export const translations = {
  es: {
    ...
    copilot: {
      ...
      greeting: '¡Hola! 🐾 Soy Lua. Siempre acompaño a Mario en cada sprint y conozco todos sus secretos de trabajo. Dime, ¿qué quieres saber de él?',
  ...
  en: {
    ...
    copilot: {
      ...
      greeting: 'Hi! 🐾 I am Lua. I accompany Mario during every sprint and know all his work habits and secrets. Tell me, what would you like to know about him?',
